...
class StoreysExplorer extends Controller {
  constructor(parent, cfg = {}) {
    ...
    if (!cfg.storeysTabElement) {
      throw "缺少設定: storeysTabElement";
    }

    if (!cfg.showAllStoreysButtonElement) {
      throw "缺少設定: showAllStoreysButtonElement";
    }

    if (!cfg.hideAllStoreysButtonElement) {
      throw "缺少設定: hideAllStoreysButtonElement";
    }

    if (!cfg.storeysElement) {
      throw "缺少設定: storeysElement";
    }
    ...
    this._storeysTabButtonElement = this._storeysTabElement.querySelector(
      ".xeokit-tab-btn"
    );
